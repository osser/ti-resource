title: Titanium Android Action Bar
...
For action items, you can add items to the action bar by creating menu items and specifying the new showAsAction property. Valid values are:
